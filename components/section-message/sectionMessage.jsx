...
const SectionMessage = ({ title, appearance, actions, children, ...props }) => {
  ...
  return (
    <>
      <div
        className={
          "flex w-full mx-auto overflow-hidden rounded  my-5 p-5 items-start" +
      ...
      >
        <div className='flex items-start justify-center w-6 pt-0.5'>
          {appearance?.trim() === "success" ? (
            <img
              ...
              className='h-full w-full max-w-max mt-0.5'
        ...
        <div className='mx-3 pt-0.5'>
          <span className='font-semibold  dark:text-blue-400 text-gray-800 text-lg'>
            {title}
          </span>
          <p className='text-sm text-gray-900 tracking-wider font-normal  leading-6'>
            {children}
          </p>
